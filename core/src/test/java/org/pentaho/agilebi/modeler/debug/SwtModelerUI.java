...
public class SwtModelerUI {
  ...
  public static void main( String[] args ) {
    System.setProperty( "org.osjava.sj.root", "src/test/resources/solution1/system/simple-jndi" ); //$NON-NLS-1$ //$NON-NLS-2$
    ModelerMessagesHolder.setMessages( new SpoonModelerMessages() );

    Reader propsReader = null;
    GeoContext geoContext = null;
    try {
      propsReader = new FileReader( new File( "src/test/resources/geoRoles.properties" ) );
