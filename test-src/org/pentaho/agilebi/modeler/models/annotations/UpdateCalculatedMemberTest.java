...
public class UpdateCalculatedMemberTest {
  ...
  private static String METADATA_TEST_FILE_PATH = "test-res/products.xmi";
  private static final String MONDRIAN_TEST_FILE_PATH = "test-res/products.with.calc.measures.mondrian.xml";
